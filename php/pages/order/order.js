...
　　　　　　complete: function (res) { },//接口调用结束的回调函数（调用成功、失败都会执行）  
     ...
     console.log(this.data.buy_id)
        ...
        wx.showModal({  
            ...
            success: function(res) {  
                ...
                wx.request({
                  url: 'http://localhost/php_5_morning/index.php/index/Order/insert_order_info',
                  method:'POST',
                  data:{
                    movie_id:movieid,
                    cinema_id:cinemaid,
                ...
                wx.request({
                  url: 'http://localhost/php_5_morning/index.php/index/Order/update_seat',
                  method:'POST',
                  data:{
                    movie_id:movieid,
                    cinema_id:cinemaid,
  ...
  /**全局变量传cinemaid，movieid */ 
    ...
    wx.request({
      url:'http://localhost/php_5_morning/index.php/index/Order/get_order_id',
      method:'GET',
      success:function(res){
    ...
    wx.request({
      url: 'http://localhost/php_5_morning/index.php/index/Cinema/get_seat_list',
      method:'POST',
      data:{
        movie_id:movieid,
        cinema_id:cinemaid
